...
const Terms = () => {
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <p>
        En publiant du contenu sur Rando Ouest (opinions, articles, images), vous garantissez :
      </p>
      <ul>
      ...
      <p>
        Nous nous réservons le droit de supprimer tout contenu non conforme à ces règles.
      </p>

      <h2>3. Responsabilité</h2>
      <p>
        Rando Ouest n'est pas responsable des accidents, dommages ou incidents pouvant survenir
        lors de l'utilisation des chemins de randonnées listés sur notre site. Chaque utilisateur
